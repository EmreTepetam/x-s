...
class DriverInstallerApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Sürücü Kurulum Aracı")
        self.setGeometry(100, 100, 600, 400)
        self.setStyleSheet("color: #333333;")  # Sadece metin için renk

        # Language State (Öncelikli olarak tanımlandı)
        ...
        # Install Button
        self.install_button = QPushButton("Sürücü Yükle", self)
    ...
    def start_installation(self):
        ...
        self.progress_value = 0
        self.progress_bar.setValue(0)
        self.show_feedback("Yükleme başlatıldı...", error=False)
        ...
        if success:
            if "zaten sistemde mevcut" in message:
                ...
                self.progress_message = "Driver yüklemesi başarılı!"
                self.progress_timer.start(50)  # Increment progress bar
        else:
